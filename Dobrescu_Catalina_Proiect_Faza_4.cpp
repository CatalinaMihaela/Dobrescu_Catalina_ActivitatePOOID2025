...
// Proiect faza 4
    ...
    for (int i = 0; i < n; i++)
    {
        ...
        cout << "Initiala: "; cin >> init;
        cout << "Brand: "; cin >> brand;

        vecD[i] = Dispozitiv(nume, baterii, init, brand);
    }
    ...
    for (int i = 0; i < m; i++)
    {
        ...
        vecC[i] = Calculator(model, ram, pret, proc);
    }
    ...
    for (int i = 0; i < k; i++)
    {
        ...
        cout << "Tip: "; cin >> tip;
        cout << "DPI: "; cin >> dpi;
        cout << "Wireless (0/1): "; cin >> w;
        cout << "Culoare: "; cin >> cul;

        vecM[i] = Mouse(tip, dpi, w, cul);
    }
    ...
    int R, C;
    cout << "Introduceti numar linii R: ";
    cin >> R;
    cout << "Introduceti numar coloane C: ";
    cin >> C;

    Calculator** matrice = new Calculator * [R];
    for (int i = 0; i < R; i++)
        matrice[i] = new Calculator[C];
